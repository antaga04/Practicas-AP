        ...
        for (columna1 = 0; columna1 < imagenDestino->width; columna1 += ANCHO) {
            ...
            for (fila2 = 0; fila2 < imagenOrigen->height; fila2 += ALTO) {
                ...
                for (columna2 = 0; columna2 < imagenOrigen->width; columna2 += ANCHO) {
                    ...
                    if ((columna1/ANCHO)%2 != 0){
                
                        if(fila1 != imagenDestino->height - ALTO){

                            nuevaDiferencia = compararBloques(fila2, columna2, imagenOrigen, fila1+(ALTO/2), columna1, imagenDestino);
                        }                                
            ...
            if ((columna1/ANCHO)%2 != 0){
                ...
                if(fila1 != imagenDestino->height - ALTO){
                    ...
                    copiarBloque(mejorFila, mejorColumna, imagenOrigen, fila1+(ALTO/2), columna1, imagenDestino);
                }                                
